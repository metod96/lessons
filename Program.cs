...
namespace test
{
    ...
    class Program
    {
      ...
      static  void formula_1(int pi, int mi, int oi, int q){
        ...
        Console.WriteLine("formula_1();  E =  " + E.ToString("0.00"));
      ...
      static  void formula_2(int pi, int mi, int oi, int q){
        ...
        Console.WriteLine("formula_2(); CKO =  " + CKO.ToString("0.00"));
        ...
        Console.WriteLine("formula_3(); summa E =  " + summa_E.ToString("0.00") );
...
static  void formula_4(){
        ...
        Console.WriteLine("formula_4(); summa CKO_k =  " + CKO_k.ToString("0.00") );
...
static  void formula_5(){
        ...
        Console.WriteLine("formula_5(); summa E_95 =  " + E_95.ToString("0.00") );
...
static  void formula_6(){
          ...
          float delta = (CKO_k /summa_E)*100;
           ...
           Console.WriteLine("formula_6(); delta =  " + delta.ToString("0.00") + "%" );
...
static  void formula_7(){
           ...
           Console.WriteLine("formula_7(); delta =  " + E_all.ToString("0.00") );
...
static  void formula_8(){
           ...
           Console.WriteLine("formula_8(); N =  " + N.ToString("0.00") );
...
static  void formula_9(){
           ...
           Console.WriteLine("formula_9(); T =  " + T.ToString("0.00") );
...
static  void formula_10(){
           ...
           Console.WriteLine("formula_10(); K =  " + K.ToString("0.00") );
